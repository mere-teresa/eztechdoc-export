...
-   Cluster: Reduce latency to Redis/Memcached, use Varnish, and use [Solr](Solr_Bundle)
...
-   Set up eZ Platform in [cluster mode](Clustering) if you need to handle more traffic than what a single server can handle on spikes of traffic.
...
-   Use [Solr Bundle and Solr](Solr_Bundle) to greatly offload your database and get more stable performance on your install
...
-   [Requirements](Step_0:_Requirements_&_System_Configuration)
