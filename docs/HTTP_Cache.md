...
*Use of Varnish is a requirement for use in Clustering setup, for overview of clustering feature see [Clustering](Clustering). *
...
-   [Overview of steps to set up Cluster](Steps_to_set_up_Cluster)[:](#HTTPCache-Persistencecacheconfiguration)
...
<tbody>
<tr class="odd">
<td align="left"><p>Note that you'll need to define &quot;SYMFONY_HTTP_CACHE&quot; instead of &quot;USE_HTTP_CACHE&quot; and &quot;SYMFONY_TRUSTED_PROXIES&quot; instead of &quot;TRUSTED_PROXIES&quot;</p>
...
<tr class="even">
<td align="left"><p>Thanks Ivan Ternovtsiy, fixed <img src="images/icons/emoticons/smile.png" alt="(smile)" class="emoticon emoticon-smile" /> </p>
<div class="smallfont" align="left" style="color: #666666; width: 98%; margin-bottom: 10px;">
