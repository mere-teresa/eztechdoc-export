...
The first sub-release of [eZ Platform 15.12](eZ_Platform_15.12_Release_notes) is now available for update.

For the release notes of the corresponding eZ Studio sub-release, see [eZ Studio 15.12.1 Release Notes](eZ_Studio_15.12.1_Release_notes).

## Changes since 15.12

As already deprecated on [requirements](../DEVELOPER/Step_0:_Requirements_&_System_Configuration) page, this release **does not support PHP 5.4** any longer.

For list of issues fixed in 15.12.1 see 13 issues , below is a list of notable bugs/features/enhancements done in the release. 
...
-   \[Twig\] New **ez\_field** function, unlike **ez\_field\_value**  returns whole Field - find more information [here.](Content_Rendering)
-   EZP-24467 - \[API\] When moving an object to an hidden container, the moved object doesn't have the hidden by superior status Closed
-   EZP-25366 - Kernel issue: By doing a subtree copy with subitems using ObjectRelation, the Relation is broken on the copy until you republish it. Closed
