...
![Diagram of an example Content item](attachments/31430275/31431657.png){.image-center}
...
![Creating a new Content Type](attachments/31430275/31431659.png){.image-center width="500"}
...
![Diagram of an example Content Type](attachments/31430275/31431660.png){.image-center}
...
[**Searchable**](Search)– a flag which indicates if the value of the Field will be indexed for searching.
...
**[Translatable](Internationalization)** – a flag which indicates if the value of the Field can be translated. This is independent of the Field Type, which means that even Fields of Types such as "Float" or "Image" can be set as translatable.
...
![Diagram of content model](attachments/31430275/31431661.png){width="610"}
...
![](images/icons/bullet_blue.gif){width="8" height="8"} [content\_model\_item\_diagram.png](attachments/31430275/31431657.png) (image/png)
![](images/icons/bullet_blue.gif){width="8" height="8"} [Admin Panel - New Content Type.png](attachments/31430275/31431659.png) (image/png)
![](images/icons/bullet_blue.gif){width="8" height="8"} [content\_model\_type\_diagram.png](attachments/31430275/31431660.png) (image/png)
![](images/icons/bullet_blue.gif){width="8" height="8"} [content\_model\_diagram.png](attachments/31430275/31431661.png) (image/png)
