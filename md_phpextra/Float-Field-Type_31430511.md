...
<span id="title-text"> Developer : Float Field Type </span> {#title-heading .pagetitle}
===========================================================
...
<span class="nx">Description</span> {#FloatFieldType-Description}
-----------------------------------

This Field Type stores numeric values which will be provided as floats.

PHP API Field Type  {#FloatFieldType-PHPAPIFieldType}
-------------------

### Input expectations {#FloatFieldType-Inputexpectations}

<span style="color: rgb(0,0,0);">The Field Type expects a number as
input. Both decimal and integer numbers are accepted.</span>
...
### Value object {#FloatFieldType-Valueobject}

##### Properties {#FloatFieldType-Properties}
...
##### Constructor {#FloatFieldType-Constructor}
...
### Validation {#FloatFieldType-Validation}
...
### Settings {#FloatFieldType-Settings}
