...
<span id="title-text"> Developer : Paginating API search results </span> {#title-heading .pagetitle}
========================================================================
...
library](https://github.com/whiteoctober/Pagerfanta){.external-link} and
[proposes adapters for
it](https://github.com/ezsystems/ezpublish-kernel/tree/master/eZ/Publish/Core/Pagination/Pagerfanta){.external-link}.
...
documentation](https://github.com/whiteoctober/Pagerfanta/blob/master/README.md){.external-link}.
...
#### In this topic: {#PaginatingAPIsearchresults-Inthistopic:}
