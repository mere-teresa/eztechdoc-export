...
This syntax is based on [Symfony's expression language](index), an extensible component that allows limited / readable scripting to be used outside code context.
