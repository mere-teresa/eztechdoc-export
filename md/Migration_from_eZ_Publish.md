...
-   XmlText fields have been replaced with a new [RichText](RichText_Field_Type)field
-   Page field (ezflow) has been replaced by the [LandingPage](Landing_Page_Field_Type__Enterprise_)field, and is now provided by our commercial product [eZ Platform Enterprise Edition](http://ezstudio.com/)
...
-   Write UI code for custom Field Types for the new Javascript-based editorial interface, see  [Extending PlatformUI with new navigation](Extending_PlatformUI_with_new_navigation) and [Creating Landing Page blocks (Enterprise)](Creating_Landing_Page_blocks__Enterprise_)
-   Adjust custom admin modules for the new Symfony-based admin interface

For a detailed guide through these developments see [Upgrading from 5.4.x and 2014.11 to 16.xx](Upgrading_from_5.4.x_and_2014.11_to_16.xx) 

 

![](attachments/31430320/31431651.png){.image-right height="250"}

## Attachments:

![](images/icons/bullet_blue.gif){width="8" height="8"} [Gondola.png](attachments/31430320/31431651.png) (image/png)
