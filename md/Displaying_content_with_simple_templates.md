...
You can also make use of different other [Twig functions](Twig_Functions_Reference), for example [ez\_field\_value](ez_field_value), which renders the value of the Field without a template.
...
To see how to list children of a Content item, for example all content contained in a folder, see [Displaying children of a Content item](Displaying_children_of_a_Content_item)
