...
For information on how to create and configure new blocks for the Landing Page, see [Creating Landing Page layouts (Enterprise)](Creating_Landing_Page_layouts__Enterprise_).

 

# Blocks

For information on how to create and configure new blocks for the Landing Page, see [Creating Landing Page blocks (Enterprise).](Creating_Landing_Page_blocks__Enterprise_)
