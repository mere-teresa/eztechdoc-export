...
-   Using [Solr](Solr_Bundle) for better search and better search performance
-   Using a CDN for improved performance and faster ping time worldwide
-   Using Active/Passive Database for failover
-   In general: Make sure to use later versions of PHP and MySQL/MariaDB within [what is supported](Step_0:_Requirements_&_System_Configuration)   for your eZ Platform version to get more performance out of each server.

![](attachments/31430387/31430385.png){width="500"}
...
-   [Overview of steps to set up Cluster](Steps_to_set_up_Cluster)[:](#Clustering-Persistencecacheconfiguration)
...
![](images/icons/bullet_blue.gif){width="8" height="8"} [Server setup.png](attachments/31430387/31430385.png) (image/png)
![](images/icons/bullet_blue.gif){width="8" height="8"} [Server setup 5.x doc.png](attachments/31430387/31430386.png) (image/png)
