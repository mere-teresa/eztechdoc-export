...
Value object: `\eZ\Publish\Core\FieldType\Image\Value`Associated Services: ezpublish.fieldType.ezimage.variation\_service
...
The template called by [the **ez\_render\_field()** Twig function](ez_render_field) while rendering a Image field accepts the following the parameters:
...
Images will be stored to web/var/ezdemo\_site/storage/images/0/8/4/1/1480-1-eng-GB.
