...
<span id="title-text"> Developer : ISBN Field Type </span>
==========================================================
...
For more details on the Value object for this Field Type please refer to the <a href="http://apidoc.ez.no/doxygen/trunk/NS/html/classeZ_1_1Publish_1_1Core_1_1FieldType_1_1ISBN_1_1Value.html" class="external-link">auto-generated documentation</a> *(todo: update link when available, see <a href="https://github.com/ezsystems/ezpublish-kernel/blob/master/eZ/Publish/Core/FieldType/ISBN/Value.php" class="external-link">here</a>* *for the value object and its doc in the mean time)*.
