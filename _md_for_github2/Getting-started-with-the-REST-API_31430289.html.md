...
<span id="title-text"> Developer : Getting started with the REST API </span>
============================================================================
...
To test further, you can use browser extensions, like <a href="https://chrome.google.com/webstore/detail/advanced-rest-client/hgmloofddffdnphfgcellkdfbfbjeloo" class="external-link">Advanced REST client for Chrome</a> or <a href="https://addons.mozilla.org/firefox/addon/restclient/" class="external-link">RESTClient for Firefox</a>, or dedicated tools. For command line users, <a href="https://github.com/jkbr/httpie" class="external-link">HTTPie</a> is a good tool.
