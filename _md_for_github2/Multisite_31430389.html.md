...
<span id="title-text"> Developer : Multisite </span>
====================================================

Created by <span class="author"> Dominika Kurek</span>, last modified on Feb 28, 2017
...
This feature is a reimplementation of the <a href="http://doc.ez.no/eZ-Publish/Technical-manual/4.x/Reference/Configuration-files/site.ini/SiteAccessSettings/PathPrefix" class="external-link">PathPrefix</a> one that existed in eZ Publish Legacy.
