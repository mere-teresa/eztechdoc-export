...
<span id="title-text"> Developer : Asset Management </span>
===========================================================

Created by <span class="author"> Dominika Kurek</span>, last modified on Nov 14, 2016
...
<a href="https://github.com/ezsystems/ezpublish-kernel/blob/native_io_spec/doc/specifications/io/native_io_handlers.md#the-native-flysystem-handler" class="external-link"></a>The native Flysystem handler
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

<a href="https://github.com/ezsystems/ezpublish-kernel/blob/native_io_spec/doc/specifications/io/flysystem.thephpleague.com" class="external-link">league/flysystem</a> (along with <a href="https://github.com/1up-lab/OneupFlysystemBundle/" class="external-link">FlysystemBundle</a>) is an abstract file handling library.
...
The way to configure other adapters can be found on the <a href="https://github.com/1up-lab/OneupFlysystemBundle/blob/master/Resources/doc/index.md#step3-configure-your-filesystems" class="external-link">bundle's online documentation</a>. Note that we do not use the Filesystem configuration described in this documentation, only the adapters.
