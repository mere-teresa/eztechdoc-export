...
<span id="title-text"> Developer : Extending the REST API </span>
=================================================================

Created by <span class="author"> Dominika Kurek</span>, last modified on Jul 04, 2016
...
Next, you need to create the REST route. We need to define the route's <a href="http://symfony.com/doc/current/cookbook/controller/service.html" class="external-link">controller as a service</a> since our controller was defined as such.
...
This syntax is based on <a href="http://symfony.com/doc/current/components/expression_language/index.html" class="external-link">Symfony's expression language</a>, an extensible component that allows limited / readable scripting to be used outside code context.
