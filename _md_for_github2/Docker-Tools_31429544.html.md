...
<span id="title-text"> Developer : Docker Tools </span>
=======================================================

Created by <span class="author"> Dominika Kurek</span>, last modified by <span class="editor"> André Rømcke</span> on Jul 13, 2016
...
If you would like to join our efforts *(development, documentation, feedback, and/or testing)*, <a href="http://ez-community-on-slack.herokuapp.com/" class="external-link">sign up</a> for our <a href="http://ezcommunity.slack.com" class="external-link">Community Slack</a> and join the conversation in the **\#docker-tools** channel.
...
What follows below is instructions for setting up a simple single-server instance of eZ Platform demo using Docker. This is here shown on your own machine, however using <a href="https://docs.docker.com/machine/" class="external-link">Docker Machine</a> you may point this to a variety of servers and services.
...
-   Docker images:
    -   <a href="https://hub.docker.com/r/ezsystems/php/" class="external-link">ezsystems/php</a>
