...
<span id="title-text"> Developer : DateAndTime Field Type </span>
=================================================================
...
String representation of the date value will generate the date string in the format "D Y-d-m H:i:s" as accepted by <a href="http://www.php.net/manual/en/function.date.php" class="external-link">PHP's built-in <strong><code>date()</code></strong> function</a>.
