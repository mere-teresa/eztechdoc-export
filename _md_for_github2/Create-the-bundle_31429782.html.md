...
Custom Field Types follow the Symfony 2 extension mechanism: <a href="http://symfony.com/doc/current/cookbook/bundles/index.html" class="external-link">bundles</a>. We can get started with a bundle using the built-in Symfony 2 bundle generator.
