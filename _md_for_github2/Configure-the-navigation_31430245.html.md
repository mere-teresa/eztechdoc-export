...
<span id="title-text"> Developer : Configure the navigation </span>
===================================================================
...
The default structure of the Navigation Hub is defined in the <a href="https://github.com/ezsystems/PlatformUIBundle/blob/master/Resources/public/js/views/services/ez-navigationhubviewservice.js#L377" class="external-link">Navigation Hub view service attributes</a>.
...
The resulting code can be seen in <a href="https://github.com/ezsystems/ExtendingPlatformUIConferenceBundle/releases/tag/5_navigation" class="external-link">the 5_navigation tag on GitHub</a>, this step result can also be viewed as <a href="https://github.com/ezsystems/ExtendingPlatformUIConferenceBundle/compare/4_view...5_navigation" class="external-link">a diff between tags <code>4_view</code> and <code>5_navigation</code></a>.
