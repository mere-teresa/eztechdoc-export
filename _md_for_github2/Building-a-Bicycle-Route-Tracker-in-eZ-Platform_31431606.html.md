...
<span id="title-text"> Developer : Building a Bicycle Route Tracker in eZ Platform </span>
==========================================================================================
...
This tutorial applies a learning-by-doing method to demonstrate how <a href="https://ezplatform.com/" class="external-link">eZ Platform</a> can be used to build a great website.
...
If you have any questions, feel free to reach out to us or our <a href="http://share.ez.no/get-involved/exchange" class="external-link">awesome community</a> for help!
