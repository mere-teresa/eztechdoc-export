...
<span id="title-text"> Developer : Performance </span>
======================================================

Created by <span class="author"> André Rømcke</span>, last modified on Mar 23, 2017
...
-   Always use reverse proxy, and strongly prefer to use Varnish.
    ...
    -   With <a href="https://github.com/ezsystems/ezplatform-http-cache" class="external-link">ezplatform-http-cache</a> support for xkey & grace provides more stable performance in read/write scenarios
