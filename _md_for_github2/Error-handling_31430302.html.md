...
<span id="title-text"> Developer : Error handling </span>
=========================================================
...
The complete list of error codes used and the conditions in which they apply are specified in the <a href="https://github.com/ezsystems/ezpublish-kernel/blob/master/doc/specifications/rest/REST-API-V2.rst" class="external-link">reference documentation</a>.
