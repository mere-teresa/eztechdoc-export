...
<span id="title-text"> Developer : MapLocation Field Type </span> {#title-heading .pagetitle}
=================================================================
...
Description {#MapLocationFieldType-Description}
-----------
...
PHP API Field Type  {#MapLocationFieldType-PHPAPIFieldType}
-------------------

### Input expectations {#MapLocationFieldType-Inputexpectations}
...
### Value object {#MapLocationFieldType-Valueobject}

##### Properties {#MapLocationFieldType-Properties}
...
##### Constructor {#MapLocationFieldType-Constructor}

<span>The **`MapLocation`**</span>**`\Value`**<span> constructor
will initialize a new Value object with the values provided. Two floats
and a string are expected.  
</span>
...
Template rendering {#MapLocationFieldType-Templaterendering}
------------------
...
### Configuration {#MapLocationFieldType-Configuration}

<span class="status-macro aui-lozenge aui-lozenge-current">THIS FEATURE
IS COMING IN EZP-26068</span><span> </span>

| Config                                                                                      | Site Access/Group aware | Description                                                                                                                                                                                                                                                           |
|---------------------------------------------------------------------------------------------|-------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span class="pl-smi">api\_keys</span><span>.</span><span class="pl-smi">google\_maps</span> | yes                     | Google maps requires use of a API key for severing maps to web pages, this setting allows you to specify your personal [Google Maps API key](https://developers.google.com/maps/documentation/javascript/get-api-key){.external-link} used during template rendering. |
