...
<span id="title-text"> Developer : NewObjectStateLimitation </span> {#title-heading .pagetitle}
===================================================================
...
<span>In the `state/assign` Policy you can combine this with
`ObjectStateLimitation` to limit both from and to values.</span>
...
###### Possible values {#NewObjectStateLimitation-Possiblevalues}
