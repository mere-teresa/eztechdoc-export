...
<span id="title-text"> Developer : Service Container </span> {#title-heading .pagetitle}
============================================================

Created by <span class="author"> Sarah Haïm-Lubczanski</span>, last
modified by <span class="editor"> Dominika Kurek</span> on Sep 27, 2016

Definition {#ServiceContainer-Definition}
==========
...
pattern](http://en.wikipedia.org/wiki/Dependency_injection){.external-link}.
...
In eZ Platform {#ServiceContainer-IneZPlatform}
==============

eZ Platform uses [Symfony service
container](http://symfony.com/doc/master/book/service_container.html){.external-link}.
...
-   [Introduction and basic
    usage](http://symfony.com/doc/master/book/service_container.html){.external-link}
-   [Full documentation of the Dependency Injection
    Component](http://symfony.com/doc/master/components/dependency_injection/index.html){.external-link}
-   [Cookbook](http://symfony.com/doc/master/cookbook/service_container/index.html){.external-link}
-   [Base service
    tags](http://symfony.com/doc/master/reference/dic_tags.html){.external-link}

Service tags {#ServiceContainer-Servicetags}
------------
...
extension](http://twig.sensiolabs.org/doc/advanced.html#creating-extensions){.external-link}
...
entry](http://symfony.com/doc/master/cookbook/templating/twig_extension.html){.external-link}
for a full example).
...
documentation](http://symfony.com/doc/master/reference/dic_tags.html){.external-link}.

### Core & API {#ServiceContainer-Core&API}
...
### Legacy {#ServiceContainer-Legacy}
